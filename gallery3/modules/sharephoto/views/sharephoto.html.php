...
<? if (module::get_var("sharephoto", "Icons")) { ?>
	<div id="dock">
		<div class="dock-container" style="height:0px;">		
			<div class="addthis_toolbox">   
				<div class="custom_images">
					...
					<a class="addthis_button_sinaweibo"><span>Weibo</span>
					<img src="<?= url::file("modules/sharephoto/images/weibo.png") ?>" /></a>
					<a class="addthis_button_qzone"><span>qzone</span>
					<img src="<?= url::file("modules/sharephoto/images/qzone.png") ?>" /></a>
